...
public class Encrypt {
    ...
    //     String encryptedTextBase64 = Encrypt.encrypt(pText.getBytes(UTF_8), PASSWORD);
    ...
    //     String decryptedText = Encrypt.decrypt(encryptedTextBase64, PASSWORD);
